...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="{!! asset('assets/backend/bower_components/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet') !!}">

    <!-- MetisMenu CSS -->
    <link href="{!! asset('assets/backend/bower_components/metisMenu/dist/metisMenu.min.css" rel="stylesheet') !!}">

    <!-- DataTables CSS -->
    <link href="{!! asset('assets/backend/bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.css') !!}" rel="stylesheet">

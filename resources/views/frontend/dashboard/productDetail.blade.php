...
@section('content')
        ...
        <div class="product-info">
          <div class="left">
            <div class="image"><a href="{!! asset('assets/frontend/image/product/canon_eos_5d_1-500x500.jpg') !!}" title="Canon EOS 5D" class="cloud-zoom colorbox" id='zoom1' rel="adjustX: 0, adjustY:0, tint:'#000000',tintOpacity:0.2, zoomWidth:360, position:'inside', showTitle:false"><img src="{!! asset('assets/frontend/image/product/canon_eos_5d_1-350x350.jpg') !!}" title="Canon EOS 5D" alt="Canon EOS 5D" id="image" /><span id="zoom-image"><i class="zoom_bttn"></i> Zoom</span></a></div>
            <div class="image-additional"> <a href="{!! asset('assets/frontend/image/product/canon_eos_5d_1-500x500.jpg') !!}" title="Canon EOS 5D" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '{!! asset('assets/frontend/image/product/canon_eos_5d_1-350x350.jpg') !!}' "><img src="{!! asset('assets/frontend/image/product/canon_eos_5d_1-350x350.jpg') !!}" width="62" title="Canon EOS 5D" alt="Canon EOS 5D" /></a> <a href="{!! asset('assets/frontend/image/product/canon_eos_5d_3-500x500.jpg') !!}" title="Canon EOS 5D" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '{!! asset('assets/frontend/image/product/canon_eos_5d_3-350x350.jpg') !!}' "><img src="{!! asset('assets/frontend/image/product/canon_eos_5d_3-350x350.jpg') !!}" width="62" title="Canon EOS 5D" alt="Canon EOS 5D" /></a> <a href="{!! asset('assets/frontend/image/product/canon_eos_5d_2-500x500.jpg') !!}" title="Canon EOS 5D" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '{!! asset('assets/frontend/image/product/canon_eos_5d_2-350x350.jpg') !!}' "><img src="{!! asset('assets/frontend/image/product/canon_eos_5d_2-350x350.jpg') !!}" width="62" title="Canon EOS 5D" alt="Canon EOS 5D" /></a> </div>
          </div>
          <div class="right">

...
@section('title', 'Edit Group Role')

@section('content')
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Edit group role</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    @if (count($errors) > 0)
        ...
        <div class="col-lg-12">
            <div class="panel panel-info">
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form role="form" action="{{ url('admin/groups/'. $data[0]->groupid) }}" method="POST">
                                {!! csrf_field() !!}
                                {!! method_field('PUT') !!}
                                                        ...
                                                        <div class="radio">
                                                            <label>
                                                                ...
                                                                @foreach ($data as $itemData)
                                                                    @if ($itemData->module == $role['module'] && $itemData->addNew == $role['addNew'] && $itemData->edit == $role['edit'] && $itemData->destroy == $role['destroy'])
                                                                        checked="checked"    
                                                                    @endif
                                                                @endforeach
                                                                >
                                ...
                                <a class="btn btn-sm btn-default" href="{!! url('admin/groups') !!}" name="cancel">Cancel</a>
